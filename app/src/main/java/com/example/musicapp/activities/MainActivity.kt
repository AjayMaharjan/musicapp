        ...
        binding.navView.setNavigationItemSelectedListener {
            when (it.itemId) {
                R.id.navExit -> {
                    ...
                    customDialog.show()
                    customDialog.getButton(AlertDialog.BUTTON_POSITIVE).setTextColor(MaterialColors.getColor(baseContext,
                        R.color.white, Color.WHITE))
                    customDialog.getButton(AlertDialog.BUTTON_POSITIVE).setBackgroundColor(MaterialColors.getColor(baseContext,
                        R.color.black_T, Color.BLACK))
                }
            }
            true
        }
